...
/**
 * Strategy for calculating monthly interest on a time deposit.
 * Each implementation encapsulates the interest rate and eligibility
...
public interface InterestStrategy {
    ...
    /**
     * Calculates the raw (unrounded) monthly interest for the given deposit.
     * Returns 0 if the deposit is not yet eligible for interest.
     *
